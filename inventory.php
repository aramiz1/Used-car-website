	...
	switch($_GET["action"]) {
		case "add":
			...
			if(!empty($_POST["quantity"])) {
				$productByCode = $db_handle->runQuery("SELECT * FROM finaltable WHERE code='" . $_GET["code"] . "'");
				$itemArray = array($productByCode[0]["code"]=>array('name'=>$productByCode[0]["name"], 'code'=>$productByCode[0]["code"], 'quantity'=>$_POST["quantity"], 'price'=>$productByCode[0]["price"], ));
				
				$_SESSION["carSelected"] = $productByCode[0]["name"];
	...
	<body>
		...
		<div class="container">		
			<div id="shopping-cart">
				...
				<a id="btnEmpty" href="inventory.php?action=empty">Empty Cart</a>
				<?php
						...
						<?php		
							foreach ($_SESSION["cart_item"] as $item){
								...
								?>
										...
										<td style="text-align:center;"><a href="inventory.php?action=remove&code=<?php //echo $item["code"]; 
			...
			<div id="product-grid">
				...
				<ul class= "navbar">
				<li><a href="inventory.php" class = "active">Cars</a></li>
				...
				?>
					<div class="product-item">
						<form method="post" action="inventory.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
						
						
										
						<div class="product-tile-footer">
						<img src="<?php echo $product_array[$key]["code"].".PNG"; ?>" class="cart-item-image">
